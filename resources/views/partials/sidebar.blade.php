                   ...
                   <ul class="metismenu" id="menu1">
                       ...
                       <li>
                           <a title="Data Kontrak" href="/kontrak" aria-expanded="false">
                               ...
                               <span class="mini-click-non">Data Kontrak</span></a>
                       </li>
                       <li>
                       ...
                       <li>
                           <a class="has-arrow" href="" aria-expanded="false"><span
                                   ...
                                   class="mini-click-non">Data Variant</span></a>
                       ...
                       <li>
                           <a title="Data Pengadaan" href="/pengadaan" aria-expanded="false">
                               <i class="fa-regular fa-calendar-days" aria-hidden="true"></i>
                               <span class="mini-click-non">Data Pengadaan</span></a>
                       </li>
                       <li>
                       ...
                       <li>
                           <a class="has-arrow" href="" aria-expanded="false"><span
                                   class="educate-icon educate-professor icon-wrap"></span> <span
                                   class="mini-click-non">Data Material</span></a>
                           <ul class="submenu-angle" aria-expanded="false">
                               <li>
                       ...
                       <li>
                           <a title="Data Satuan" href="/satuan" aria-expanded="false">
                               <i class="fa-regular fa-calendar-days" aria-hidden="true"></i>
                               <span class="mini-click-non">Data Satuan</span></a>
                       </li>
                       <li>
                           <a title="Data PRK" href="/prk" aria-expanded="false">
                               <i class="fa-regular fa-calendar-days" aria-hidden="true"></i>
                               <span class="mini-click-non">Data PRK</span></a>
                       </li>
                       <li>
                           <a class="has-arrow" href="" aria-expanded="false"><span
                                   class="educate-icon educate-professor icon-wrap"></span> <span
