                        ...
                        <form method="post" action="/rincian-nilai-kontrak">
                            ...
                            <div class="container">
                                ...
                                <div class="col-lg-12" style="margin-top: 10px">
                                    ...
                                    <select class="form-control custom-select-value" name="prk_id" id="prk_id">
                                ...
                                <div class="col-lg-4" style="margin-top: 10px">
                                    <label for="variant_id" class="form-label">Variant
                                        Type</label>
                                    <select class="form-control custom-select-value" name="variant_id" id="variant_id">
                                ...
                                <div class="col-lg-4" style="margin-top: 10px">
                                    ...
                                    <select class="form-control custom-select-value" name="up3" id="up3">
                                ...
                                <div class="col-lg-4" style="margin-top: 10px">
                                    ...
                                    <input type="text" class="form-control" name="volume" id="vol">
                                </div>
                                <div class="col-lg-4" style="margin-top: 10px">
                        ...
                        <form action="" method="POST">
                            ...
                            <div class="modal-body">
                                <div class="mb-3">
                                    ...
                                    <select class="form-control custom-select-value" name="rab_id" id="kode_rab">
                                        @foreach ($rabs as $rab)
                                            <option value="{{ $rab->id }}">{{ $rab->kode_rab }}
                                            </option>
                                        @endforeach
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" name="prk_id" id="unit">
                                </div>
                                <div class="mb-3">
                                    <label for="nama_variant" class="form-label">Variant Type</label>
                                    <input type="text" class="form-control" name="variant_id" id="nama_variant">
                                </div>
                                <div class="mb-3">
                                    <label for="nama_satuan" class="form-label">Satuan</label>
                                    <input type="text" class="form-control" name="satuan_id" id="nama_satuan">
                                </div>
                                <div class="mb-3">
                                    <label for="volume" class="form-label">Volume</label>
                                ...
                                <div class="mb-3">
                                    <label for="alokasi" class="form-label">Alokasi
                                        Bulan</label>
                                    <input type="text" class="form-control" name="alokasi_bulan" id="alokasi">
                                </div>
                                <div class="mb-3">
                                    <label for="hargasatuan" class="form-label">Harga Satuan</label>
                                    <input type="text" class="form-control" name="harga_satuan" id="hargasatuan">
                                </div>
                                <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" name="total" id="totals">
                                </div>
                            </div>
                            <div class="modal-footer">
                                <button data-dismiss="modal" class="btn btn-cusom-four btn-primary">Cancel</button>
                                    ...
                                    <thead>
                                        <tr>
                                            ...
                                            <th data-field="harga_transport" data-editable="true"
                                                class="harga_transport">Harga Transport
                                            </th>
