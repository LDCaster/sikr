    ...
    <div class="datatable-dashv1-list custom-datatable-overright">
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header header-color-modal bg-color-1">
                        <h4 class="modal-title">Tambah Data Pengawas Pekerjaan</h4>
                        <div class="modal-close-area modal-close-df">
                            <a class="close" data-dismiss="modal" href="#"><i class="fa fa-close"></i></a>
                        </div>
                    </div>
                    <div class="modal-body">
                        <form method="post" action="/pengawas-pekerjaan">
                            @csrf
                            <div class="mb-3">
                                <label for="pengawas_pekerjaan" class="form-label">Pengawas Pekerjaan</label>
        ...
        <div id="ModalEdit" class="modal modal-edu-general default-popup-PrimaryModal fade" role="dialog">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header header-color-modal bg-color-1">
                        <h4 class="modal-title">Ubah Data Pengawas Pekrjaan</h4>
                        <div class="modal-close-area modal-close-df">
                            <a class="close" data-dismiss="modal" href="#"><i class="fa fa-close"></i></a>
                        </div>
                    </div>
                    <div class="modal-body">
                        <form action="" method="POST">
                            ...
                            @method('put')
                            <div class="mb-3">
                                <label for="pengawas_pekerjaan" class="form-label">Pengawas Pekrjaan</label>
                                <input type="text" class="form-control" name="pengawas_pekerjaan"
                ...
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="sparkline13-list">
                            <h3 style="margin-left: 15px; font-family: 'Roboto Condensed', sans-serif;"> Data Pengawas
                                Pekerjaan</h3>
                            <hr>
                            ...
                            <section class="menu-menu">
                                ...
                                <div class="col-sm-10">
                                    <form action="{{ url('/pengawas-pekerjaan-import') }}" method="POST"
                            ...
                            <table id="table" data-toggle="table" data-pagination="true" data-search="true"
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <th data-field="nama_direksi" data-editable="true">Pengawas Pekerjaan</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    @foreach ($pengawass as $pengawas)
                                        <tr>
                                            <td>
                                                ...
                                                <button class="btn btn-warning btn-sm edit" value="{{ $pengawas->id }}"
                                                    data-toggle="modal" data-target="#ModalEdit">
                                                    <i class="fa-regular fa-pen-to-square"></i>
                                                </button>
                                                <form class="d-inline" style="display: inline"
                                                    action="{{ url('/pengawas-pekerjaan', $pengawas->id) }}"
                                                    method="POST">
                                                    @method('delete')
                                                    @csrf
                                                    <button type="submit" class="btn btn-danger btn-sm"
                                                        onclick="return confirm('Apakah anda yakin untuk hapus data Pengawas Pekerjaan?')">
                                            ...
                                            <td>{{ $pengawas->pengawas_pekerjaan }}</td>
                                        </tr>
                                    @endforeach
                                </tbody>
                            </table>
