                            ...
                            <div class="modal-body">
                                ...
                                <div class="container">
                                    <div class="col-lg-6">
                                        <label for="pengadaan_id" class="form-label">Jenis
                                            Pengadaan</label>
                                        <select class="form-control custom-select-value" name="pengadaan_id">
                                    ...
                                    <div class="col-lg-6">
                                        <label for="pabrikan_id" class="form-label">Nama
                                            Pabrikan</label>
                                        <select class="form-control custom-select-value" name="pabrikan_id" id="nm_vendor">
                                    ...
                                    <div class="col-lg-6">
                                        <label for="nama_direktur" class="form-label">Nama
                                            Direktur</label>
                                        <input type="text" class="form-control" name="nama_direktur" id="nm_direktur"
                                            readonly>
                                    </div>
                                    <div class="col-lg-6">
                                        <label for="jabatan" class="form-label">Jabatan</label>
                                        <input type="text" class="form-control" name="jabatan" id="jbtn" readonly>
                                    </div>
                                    <div class="col-lg-4">
                                    ...
                                    <div class="col-lg-4">
                                        ...
                                        <input type="text" class="form-control  " name="email" id="eml" readonly>
                                    </div>
                                    <div class="col-lg-4">
                                        <label for="no_telp" class="form-label">Nomor
                                            Telepon</label>
                                        <input type="text" class="form-control  " name="no_telp" id="notelp" readonly>
                                    </div>
                                    <div class="col-lg-4">
                                        <label for="nama_bank" class="form-label">Nama Bank</label>
                                        <input type="text" class="form-control  " name="nama_bank" id="nm_bank"
                                            readonly>
                                    </div>
                                    <div class="col-lg-4">
                                        <label for="cabang" class="form-label">Cabang</label>
                                        <input type="text" class="form-control  " name="cabang" id="cbng" readonly>
                                    </div>
                                    <div class="col-lg-4">
                                        <label for="no_rekening" class="form-label">No
                                            Rekening</label>
                                        <input type="text" class="form-control  " name="no_rekening" id="norekening"
                                            readonly>
                                    </div>
                                    <div class="col-lg-6">
                                ...
                                <div class="container">
                                    <div class="col-lg-4">
                                        ...
                                        <select class="form-control custom-select-value" name="rab_id" id="kd_rab">
                                    ...
                                    <div class="col-lg-4">
                                        ...
                                        <input type="text" class="form-control" name="prk" id="noprk"
                                            readonly>
                                    </div>
                                    <div class="col-lg-4">
                                        <label for="user" class="form-label">User</label>
                                        <input type="text" class="form-control" name="user" id="nm_user"
                                            readonly>
                                    </div>
                                    <div class="col-lg-6">
                                    ...
                                    <div class="col-lg-6">
                                        <label for="terbilang_kontrak" class="form-label">Terbilang
                                            Kontrak</label>
                                        <input type="text" class="form-control" name="terbilang_kontrak">
                                    </div>
                                    <div class="col-lg-6">
                                        <label for="nilai_jamlak" class="form-label">Nilai
                                            Jamlak</label>
                                        <input type="text" class="form-control" name="nilai_jamlak">
                                    </div>
                                    <div class="col-lg-6">
                                        <label for="terbilang_jamlak" class="form-label">Terbilang
                                            Jamlak</label>
                                        <input type="text" class="form-control" name="terbilang_jamlak">
                                    </div>
                                </div>
                                {{-- End DATA RAB --}}
                                ...
                                <div class="container">
                                    ...
                                    <div class="col-lg-3">
                                        <label for="terbilang_waktu" class="form-label">Terbilang
                                            Waktu</label>
                                        <input type="text" class="form-control" name="terbilang_waktu">
                                    </div>
                                    <div class="col-lg-3">
                                        <label for="direksi_pekerjaan" class="form-label">Direksi
                                            Pekerjaan</label>
                                        <input type="text" class="form-control" name="direksi_pekerjaan">
                                    </div>
                                    <div class="col-lg-3">
                                ...
                                <div class="container">
                                    <div class="col-lg-6">
                                        ...
                                        <select class="form-control custom-select-value" name="jmaterial_id">
                            ...
                            <div class="modal-body">
                                ...
                                <div class="container">
                                    ...
                                    <div class="col-lg-3">
                                        <label for="bt_kr" class="form-label">Bulan Tahun
                                            KR</label>
                                        <input type="text" class="form-control" name="bt_kr" id="bt_kr">
                                    </div>
                                    <div class="col-lg-3">
                                        <label for="tanggal_kr" class="form-label">Tanggal
                                            KR</label>
                                        <input type="date" class="form-control" name="tanggal_kr" id="tanggal_kr">
                                    </div>
                                </div>
                                {{-- START DATA KOntrak RInci --}}
                                ...
                                <div class="container">
                                    <div class="col-lg-4">
                                        <label for="rab_id" class="form-label">Kode RAB</label>
                                        <select class="form-control custom-select-value" name="rab_id" id="rab_id">
                                            <option value="">-- Pilih RAB ---
                                            </option>
                                            @foreach ($rabs as $rab)
                                                <option value="{{ $rab->id }}">
                                    ...
                                    <div class="col-lg-4">
                                        <label for="prk" class="form-label">Nomor PRK</label>
                                        <input type="text" class="form-control" name="prk" id="prk"
                                            readonly>
                                    </div>
                                    <div class="col-lg-4">
                                        <label for="user" class="form-label">User</label>
                                ...
                                <div class="container">
                                    ...
                                    <div class="col-lg-3">
                                        <label for="wd_kontrak" class="form-label">Waktu Durasi
                                            Kontrak</label>
                                        <input type="text" class="form-control" name="wd_kontrak" id="wd_kontrak">
                                    </div>
                                    <div class="col-lg-3">
                                        <label for="terbilang_waktu" class="form-label">Terbilang
                                            Waktu</label>
                                ...
                                <div class="container">
                                    ...
                                    <div class="col-lg-2">
                                        <label for="satuan_id" class="form-label">Satuan</label>
                                        <select class="form-control custom-select-value" name="satuan_id" id="satuan_id">
                                            <option value="">-- Pilih Satuan ---
                                            </option>
                                            @foreach ($satuans as $satuan)
                                                <option value="{{ $satuan->id }}">
                                    ...
                                    <div class="col-lg-3">
                                        <label for="no_type" class="form-label">Nomor Type
                                            Test</label>
                                        <input type="text" class="form-control" name="no_type" id="no_type">
                                    </div>
                                    <div class="col-lg-3">
                                        <label for="no_spm" class="form-label">Nomor SPM</label>
