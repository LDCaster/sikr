                        ...
                        <form method="post" action="/harga-satuan">
                            <div class="modal-body">
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-control custom-select-value" name="pabrikan_id" id="pabrikan_id">
                        ...
                        <form action="" method="POST">
                            <div class="modal-body">
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-control custom-select-value" name="pabrikan_id_edit"
                                        id="pabrikan_id_edit">
                                        <option value="">-- Pilih No KHS ---</option>
                                        @foreach ($pabrikans as $pabrikan)
                                            <option value="{{ $pabrikan->id }}">
