...
@section('content')
    ...
    <div class="sparkline13-graph">
        <div class="datatable-dashv1-list custom-datatable-overright">
            ...
            <div class="container">
                <h1 style="margin-left: 15px; font-family: 'Roboto Slab', serif;">Data Jenis Material</h1>
                <hr>
                ...
                <section class="menu-menu">
                    ...
                    <div class="col-sm-10">
                        <form action="{{ url('/jenis-material-import') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="col-sm-5">
                        ...
                        @foreach ($jmaterials as $jmaterial)
                            <tr>
                                <td>
                                    ...
                                    <button class="btn btn-warning btn-sm edit" value="{{ $jmaterial->id }}"
                                        data-toggle="modal" data-target="#ModalEdit">
                                        <i class="fa-regular fa-pen-to-square"></i>
                                    </button>
                                    <form class="d-inline" style="display: inline"
                                        action="{{ url('/jenis-material', $jmaterial->id) }}" method="POST">
                                        @method('delete')
                                        @csrf
