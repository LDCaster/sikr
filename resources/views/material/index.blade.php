...
@section('content')
    ...
    <div class="sparkline13-graph">
        <div class="datatable-dashv1-list custom-datatable-overright">
            ...
            <div class="container">
                <h1 style="margin-left: 15px; font-family: 'Roboto Slab', serif;">Data Material</h1>
                <hr>
                ...
                <section class="menu-menu">
                    ...
                    <div class="col-sm-10">
                        <form action="{{ url('/material-import') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="col-sm-5">
                        ...
                        @foreach ($materials as $material)
                            <tr>
                                <td>
                                    ...
                                    <button class="btn btn-warning btn-sm edit" value="{{ $material->id }}"
