...
@section('content')
    ...
    <div class="sparkline13-graph">
        <div class="datatable-dashv1-list custom-datatable-overright">
            ...
            <div class="container">
                <h1 style="margin-left: 15px; font-family: 'Roboto Slab', serif;">Data Pabrikan</h1>
                <hr>
                ...
                <table id="table" data-toggle="table" data-pagination="true" data-search="true"
                    data-show-columns="true" data-show-pagination-switch="flase" data-show-refresh="true"
                        ...
                        @foreach ($pabrikans as $pabrikan)
                            <tr>
                                <td>
                                    ...
                                    <button class="btn btn-warning btn-sm edit" value="{{ $pabrikan->id }}"
